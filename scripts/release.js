 ...
 * @param {string} version - Version string like "5.0.0-OS21"
 * @returns {number} - The versionCode (21)
 */
 ...
 * @returns {string} - Next version like "5.0.0-OS22"
 */
...
async function getCommitsSinceLastTag() {
  try {
    ...
    // Example: 5.0.0-OS21, 5.0.0-OS22, etc.
